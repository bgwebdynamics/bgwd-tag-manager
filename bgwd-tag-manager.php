...
$myUpdateChecker->setAuthentication('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');
...
function bgwd_gtm_register_body_hook() {
	...
	elseif ( has_action( 'nectar_hook_after_body_open' ) ) {
		add_action( 'nectar_hook_after_body_ts', 'bgwd_gtm_add_body' );
	}
